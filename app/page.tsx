  ...
  const experiences = [
    {
      ...
      description: "Contributed to backend queue management and frontend development for RightQ, an enterprise queue management system. Developed and maintained user interfaces using React while implementing robust backend services with Node.js, Bull MQ, Redis, and MQTT within a microservices architecture.",
      achievements: [
        "Part of the engineering team that developed RightQ v3, reducing queue load time by 40% compared to previous versions, resulting in MTN Nigeria adopting the platform across their entire Nigerian branch network serving 100,000+ daily customers and processing millions of transactions",
        "Implemented microservices using Bull MQ, Redis, and MQTT to create automated queue services including customer calling, queue joining, and ticket prioritization with real-time updates, improving system response time by 60% and system reliability to 99.5% uptime",
        "Integrated subscription-based payment service into the queueing system, enabling dynamic control of services, users, and ticket allocation based on payment tiers, increasing platform revenue potential by 3x",
        "Built high-level analytics dashboard tracking daily company performance, agent statistics, and queue metrics, providing actionable insights that improved operational efficiency by 35%",
        "Executed strategic code refactoring that enhanced overall application speed by 50% and collaborated in agile development cycles, consistently delivering features across 20+ sprint iterations",
      ],
      skills: ["React", "Node.js", "Bull MQ", "Redis", "MQTT", "REST API", "TypeScript", "Microservices"],
    },
    {
      ...
      description: "Crafted responsive User and Admin dashboards by translating Figma UI designs into functional interfaces using Vue.js, SASS, Element UI, and Bootstrap. Developed front-end services and integrated them with RESTful API within a microservices architecture.",
      achievements: [
        "Built responsive User and Admin dashboards from Figma designs, improving user engagement by 40% and reducing average task completion time by 45% through intuitive navigation and streamlined workflows",
        "Optimized frontend performance achieving 50% faster page load times (from 4s to 2s), improved Lighthouse scores from 65 to 92, and reduced initial bundle size by 40% through lazy loading and code splitting",
        "Integrated frontend services with RESTful API in microservices architecture, reducing API response rendering time by 35% through efficient state management and achieving 98% cross-browser compatibility",
      ],
    ...
    },
    {
      ...
      description: "Contributed to the development of ATLAS General, a US-based insurance platform serving thousands of users, working within a microservices architecture using Laravel, Node.js, Express.js, Vue.js, TypeScript, and REST API.",
      achievements: [
        "Developed and maintained 15+ RESTful APIs with 95%+ test coverage, supporting core insurance workflow features for 1,000+ daily active users",
        "Built responsive frontend components using Vue.js and transformed legacy DOM PDF generation into modern RESTful API using Laravel 8, reducing document processing time by 60%",
        "Collaborated on microservices architecture migration from legacy PHP to Node.js and implemented payment processing integrations that contributed to team's 85% reduction in transaction completion time",
        "Participated in code reviews and agile development cycles, delivering features across 6+ sprint iterations",
      ],
      skills: ["Laravel", "Node.js", "Express.js", "Vue.js", "TypeScript", "REST API", "PHP", "Microservices"],
    },
  ];
